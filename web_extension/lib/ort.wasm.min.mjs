...
var wt = (e) => _n(Ve({}, "__esModule", { value: !0 }), e);
var Se,
  q,
  pe,
  Dn,
    ...
    ((Se = new Map()),
      ...
      (ht = async (e) => {
        ...
        return [
          r,
          new Proxy(e, {
            get: (u, f) => (f === "executionProviders" ? a : Reflect.get(u, f)),
          }),
        ];
      }));
  });
    ...
    ((Tt = (e, t) => {
      ...
      (It = (e, t) => {
        ...
        if (n != null) {
          ...
          for (let T = 0; T < i * r; p += d, h += d, y += d, A += d, T++)
...
var Xe,
  ...
  Dt = E(() => {
    ...
    ((Xe = (e, t) => {
      ...
      return u === "RGBA"
        ? new x("float32", l, [1, 4, n, o])
        : new x("float32", l, [1, 3, n, o]);
    }),
      (Ot = async (e, t) => {
      ...
      (xt = () => {
        if (!Ut) {
          ...
          (e && (Y.set("int64", BigInt64Array), me.set(BigInt64Array, "int64")),
            t &&
              (Y.set("uint64", BigUint64Array),
              me.set(BigUint64Array, "uint64")),
            o
              ? (Y.set("float16", n), me.set(n, "float16"))
      ...
      async run(t, n, o) {
        ...
        for (let f in a)
          if (Object.hasOwnProperty.call(a, f)) {
            ...
            l instanceof G
              ? (u[f] = l)
              : (u[f] = new G(l.type, l.data, l.dims));
          }
    ...
    ((Kt = typeof location > "u" ? void 0 : location.origin),
      ...
      (Cn = () => {
        if (!!1) {
          if (vn) {
            let e = URL;
            return new URL(new e("ort.wasm.min.mjs", import.meta.url).href, Kt)
              .href;
          }
      ...
      (Fn = async (e) =>
        (await import(/*webpackIgnore:true*/ /*@vite-ignore*/ e)).default),
      (Zt = (Yt(), wt(qt)).default),
      (en = async () => {
        if (!R)
          throw new Error(
  ...
  tt = E(() => {
    ...
    ((jn = (e, t) => {
      ...
      (_e = async (e, t) => {
        ...
        try {
          if (
            (([s, u] = await sn(t)), t?.externalData && r.mountExternalData)
          ) {
            let g = [];
            for (let T of t.externalData) {
              let U = typeof T == "string" ? T : T.path;
              g.push(
                be(typeof T == "string" ? T : T.data).then((M) => {
          ...
          for (let g = 0; g < c; g++) {
            ...
            (h.push(v),
              A.push(
                U === 0
                  ? { name: v, isTensor: !1 }
                  : { name: v, isTensor: !0, type: Fe(U), shape: M },
              ));
          }
          for (let g = 0; g < d; g++) {
            let [T, U, M] = dn(i, g + c);
          ...
          return (ue.set(i, [i, f, l, null, p, !1]), [i, h, y, A, m]);
        } catch (c) {
          throw (
            f.forEach((d) => r._OrtFree(d)),
            l.forEach((d) => r._OrtFree(d)),
            a !== 0 &&
              r._OrtReleaseBinding(a) !== 0 &&
      ...
      (ln = async (e, t, n, o, r, i, s = !1) => {
        ...
        try {
          l.forEach((w, B) =>
            a.setValue(A + B * u, w, u === 4 ? "i32" : "i64"),
          );
      ...
      (Ue = async (e, t, n, o, r, i) => {
        ...
        try {
          ...
          for (let b = 0; b < y; b++)
            (s.setValue(v + b * a, B[b], "*"),
              s.setValue(de + b * a, l[t[b]], "*"));
          for (let b = 0; b < A; b++)
            (s.setValue(re + b * a, g[b], "*"),
              s.setValue(ct + b * a, c[o[b]], "*"));
          (s.jsepOnRunStart?.(f), s.webnnOnRunStart?.(f));
          let N;
          ((N = await s._OrtRun(f, de, v, y, ct, A, re, m)),
          ...
          for (let b = 0; b < A; b++) {
            ...
            try {
              ...
              let pt = s.getValue($ + a * 2, "*"),
                On = Number(s.getValue($ + a * 3, je)),
                H = [];
              for (let D = 0; D < On; D++)
                H.push(Number(s.getValue(pt + D * a, je)));
              ...
              if (P === "string") {
                ...
                let D = s.webnnCreateMLTensorDownloader(C, P)(),
                  L = z.length;
                ((oe = !0),
                  dt.push(
                    (async () => {
                      let V = [L, await D];
                      return (
                        s.webnnReleaseTensorId(C),
                        s._OrtReleaseTensor(W),
                        V
                      );
                    })(),
                  ),
              ...
              (s.stackRestore(lt),
                ...
                oe || s._OrtReleaseTensor(W));
            }
          }
          d &&
            !p &&
            (s._OrtClearBoundOutputs(d.handle) !== 0 &&
              S("Can't clear bound outputs."),
    ...
    ((ne = () => !!O.wasm.proxy && typeof document < "u"),
      ...
      (pn = async () => {
        if (!Ge) {
          ...
          try {
            (await Be(O.wasm), await Le(O), (Ge = !0));
          } catch (e) {
            throw (($e = !0), e);
          } finally {
            ye = !1;
    ...
    ((En = (e, t) => {
      ...
      (ze = class {
        ...
        async run(t, n, o) {
          ...
          let u = r.map((d, p) =>
              En(d, () => `input "${this.inputNames[i[p]]}"`),
            ),
            f = s.map((d, p) =>
              d ? En(d, () => `output "${this.outputNames[a[p]]}"`) : null,
            ),
            l = await yn(this.sessionId, i, u, a, f, o),
            c = {};
          for (let d = 0; d < l.length; d++)
            c[this.outputNames[a[d]]] = s[d] ?? Yn(l[d]);
          return (X(), c);
        }
        startProfiling() {}
        endProfiling() {
...
Object.defineProperty(O.versions, "web", { value: jt, enumerable: !0 });
export {
